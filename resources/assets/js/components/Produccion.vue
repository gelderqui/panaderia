    ...
    <!-- Ejemplo de tabla Listado -->
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Distribucion
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="area in arrayArea" :key="area.id">
                                    <td>
                                        <button type="button" @click="abrirModal('producto','actualizar',producto)" class="btn btn-success btn-sm">
                                          <i class="icon-eye"></i>
                                        </button> &nbsp;
                                        <template v-if="area.condicion">
                                            <button type="button" class="btn btn-danger btn-sm" @click="desactivarProducto(area.id)">
                ...
                <div class="form-group row border">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control col-md-3" v-model="idlcase" @click="selectClase()">
                                <option value="0" disabled>Seleccione una clase </option>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <select v-if="criterioA==='idclase'" class="form-control col-md-3" v-model="buscarA" @click="listarProducto(buscarA,criterioA)">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" v-model="buscarB" @keyup.enter="listarSucursal(buscarB,criterioB)" class="form-control" placeholder="Texto a buscar">
            ...
            buscarSucursal(){
                ...
                axios.get(url).then(function(response){
                    ...
                    if(me.arraySucursal.length>0){
                        ...
                        me.producto='no existe sucursal';
                        me.idsucursal=0;
                        me.sucursal='';
                        me.alias='';
                        me.tipo='';
