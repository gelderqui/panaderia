                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <select v-if="criterio==='tipo'" class="form-control col-md-3" v-model="buscar" @click="listarSucursal(1,buscar,criterio)">
                                    <option value="Sucursal">Sucursal</option>
                                    <option value="Franquicia">Franquicia</option>
                                    </select>
                                    <input v-else type="text" v-model="buscar" @keyup.enter="listarSucursal(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="sucursal in arraySucursal" :key="sucursal.id">
                                    ...
                                    <td v-text="sucursal.codigo"></td>
                                    <td v-text="sucursal.tipo"></td>
                                    <td v-text="sucursal.ubicacion"></td>
                                    <td>
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="ubicacion" class="form-control" placeholder="Ingrese Ubicación">
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods : {
            ...
            desactivarsucursal(id){
               swal({
                title: '¿Esta seguro de desactivar este sucursal?',
                type: 'warning',
            ...
            activarSucursal(id){
               swal({
                title: '¿Esta seguro de activar este sucursal?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
            ...
            validarSucursal(){
                ...
                if (!this.nombre) this.errorMostrarMsjSucursal.push("El nombre de sucursal no debe estar vacio.");
                if (!this.alias) this.errorMostrarMsjSucursal.push("El alias no debe estar vacio.");
                if (!this.alias) this.errorMostrarMsjSucursal.push("El codigo no debe estar vacio.");
                if (!this.alias) this.errorMostrarMsjSucursal.push("El tipo no debe estar vacio.");
                if (!this.ubicacion) this.errorMostrarMsjSucursal.push("La ubicacion no debe estar vacio.");
